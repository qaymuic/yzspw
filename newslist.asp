          ...
          <td><table width="776"  border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td width="596" valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="5">
                <tr>
                  <td>&nbsp;<a href="index.asp">返回首页</a>&nbsp;&nbsp;&gt;&gt;&gt;&nbsp;&nbsp;商铺动态</td>
                </tr>
              </table>
                	<%
dim strFileName
...
sql="select * from ytiinews where BigClassName='商铺动态' and istop=false"
                      ...
                      <table width="100%"  border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          <td height="25" class="td-tianchong-4px"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <td bgcolor="#eeeeee" class="td-tianchong-4px"><strong>商铺动态列表： </strong></td>
                            </tr>
                          </table></td>
                        </tr>
                      </table>
                      ...
                      <TABLE width=95% border=0 align="center" cellPadding=0 cellSpacing=0 style="FONT-SIZE: 12px">
                        <TBODY>
                          ...
                          <TR>
                            ...
                            <TD vAlign=center width=76%><A  href="list.asp?id=<%=rs("id")%>" target=_blank><%=gotTopic(rs("title"),62)%></A>　 </TD>
