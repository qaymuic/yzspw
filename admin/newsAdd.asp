...
<form method="POST" name="myform" onSubmit="return CheckForm();" action="newsSave.asp?action=add" target="_self">
  <table width="615" border="0" align="center" cellpadding="0" cellspacing="0" class="border">
	...
	<table width="100%" border="0" cellpadding="2" cellspacing="0">
          <tr> 
            ...
            <td width="500">商铺动态<input type="hidden" name="BigClassName" value="商铺动态">              </td>
          </tr>
          <tr> 
            <td align="right">标　　题：</td>
            <td width="500"><input name="Title" type="text" id="Title" size="70" maxlength="255"></td>
          </tr>
          <tr> 
...
是</td>
  ...
  <div align="center">
    <p> 
      <input
  name="Add" type="submit"  id="Add" value=" 添 加 " onClick="document.myform.action='newsSave.asp?action=add';document.myform.target='_self';">
      　&nbsp; 
