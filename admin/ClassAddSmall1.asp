...
if Action="Add" then
	...
	if FoundErr<>True then
		...
		rs.open "Select * From a2 Where BigClassName='" & BigClassName & "' AND SmallClassName='" & SmallClassName & "'",conn,1,3
		if not rs.EOF then
			FoundErr=True
...
<body>
<form name="form2" method="post" action="ClassAddSmall1.asp" onsubmit="return checkSmall()">
  <table width="400" border="0" align="center" cellpadding="2" cellspacing="2" class="border">
	...
	rsBigClass.open "Select * From a1",conn,1,1
