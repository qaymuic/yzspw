...
sql="select * from ytiinews where trim(BigClassName)<>'商铺动态'"
if Title<>"" then
...
<br>
<p align="center">
  <strong>管理选项：</strong><a href="ArticleAdd.asp">新增内容</a></p>
<table width="95%" class="border" align="center">
  <tr class="tdbg" align="center"><form name="form3" method="get" action="ArticleManage.asp">
...
<table width="95%" border="0" align="center" cellpadding="3" cellspacing="1" class="border">
  <tr class="title"> 
    <td  width="74" height="22" align="center"><strong>大类</strong></td>
    <td  width="67" align="center"><strong>小类</strong></td>
    <td  width="294" height="22" align="center"><strong>内容标题</strong></td>
    <td  width="58" height="20" align="center"><strong> 点击数</strong></td>
    <td  width="68" height="20" align="center"><strong> 发布时间</strong></td>
    <td  width="140" height="20" align="center"><strong> 操作</strong></td>
  </tr>
  <%do while not rs.EOF %>
  <tr class="tdbg"> 
    <td width="74" height="25"><%=rs("bigclassname")%></td>
    <td width="67" height="25"><%=rs("SmallClassName")%></td>
    ...
    <td width="140" height="25" align="center"><a href="ArticleModify.asp?ID=<%=rs("ID")%>">修改</a>&nbsp;&nbsp;<a href="ArticleDel.asp?ID=<%=rs("ID")%>" onClick="return ConfirmDel();">删除</a></td>
  </tr>
  <%
	i=i+1
