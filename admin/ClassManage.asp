...
<div align="center"> 
  <p><font size="6"> 栏 目 管 理</font><br><br>
    管理选项：<a href="ClassAddBig.asp">添加管理大类</a></p>
...
%>
    <tr class="tdbg"> 
      ...
      <td align="center"><a href="ClassAddSmall.asp?BigClassName=<%=rsBigClass("BigClassName")%>">添加子栏目</a> | <a href="ClassModifyBig.asp?BigClassID=<%=rsBigClass("BigClassID")%>">修改</a> 
