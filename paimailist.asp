          ...
          <td><table width="776"  border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td width="596" valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="5">
                <tr>
                  <td>&nbsp;<a href="index.asp">返回首页</a>&nbsp;&nbsp;&gt;&gt;&gt;&nbsp;&nbsp;商铺拍卖</td>
                </tr>
              </table>
...
sql="select * from ytiinews where BigClassName='商铺拍卖'"
...
%>
           ...
           sql2 = "select top 1 * from ytiinews where BigClassName='商铺拍卖' and istop=true order by id desc"
                      ...
                      <table width="100%"  border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          <td height="25" class="td-tianchong-4px"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <td bgcolor="#eeeeee" class="td-tianchong-4px"><strong>商铺拍卖列表： </strong></td>
                            </tr>
                          </table></td>
                        </tr>
                      </table>
