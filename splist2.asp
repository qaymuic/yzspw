...
<table width="778" border="0" align="center" cellpadding="0" cellspacing="0" class="table-body">
          ...
          <td><table width="776"  border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td width="180" valign="top"><table width="89%"  border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#CCCCCC">
                ...
                <tr>
                  <td bgcolor="#FFFFFF"><div align="center"><a href="splist2.asp?spgqlb=&#36716;&#35753;">商铺转让</a></div></td>
                </tr>
                <tr>
                  <td bgcolor="#FFFFFF"><div align="center"><a href="splist2.asp?spgqlb=&#20986;&#21806;">商铺出售</a></div></td>
                </tr>
                <tr>
                  <td align="center" bgcolor="#FFFFFF"><a href="splist2.asp?spgqlb=&#27714;&#36141;">商铺求购</a></td>
                </tr>
              </table>
                <br>
		   ...
		   %>
            <tr>
                    <td bgcolor="#FFFFFF"><div align="center"><a href="splist2.asp?splb=<%=rs1("SpecialName")%>"><%=trim(rs1("SpecialName"))%></a></div></td>
            </tr><%
		     rs1.movenext
    	     loop
 ...
 <%
					...
					dim i,j
					strFileName="splist2.asp?splb="&splb&"&spgqlb="&spgqlb
					dim strPurview
					...
					sql="select * from spw where sptop1=false and  spgqlb in ('转让','出售','求购') "
              ...
              <td width="596" valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="5">
                <tr>
                  <td>&nbsp;<a href="index.asp">返回首页</a>&nbsp;&gt;&gt;&gt;&nbsp;商铺买卖<%if splb<>"" then response.write "&nbsp;&gt;&gt;&gt;&nbsp;"&splb%></td>
                </tr>
              </table>
