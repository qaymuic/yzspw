...
for each formName in upload.file ''列出所有上传了的文件
 ...
 if fileext<>"jpg" and fileext<>"bmp" and fileext<>"gif" and fileext<>"swf" then
...
sub HtmEnd(Msg)
	...
	response.write "<span style=""font-family: 宋体; font-size: 9pt"">文档上传成功！</span>"
response.end
end sub
