...
<table width="778" border="0" align="center" cellpadding="0" cellspacing="0" class="table-body">
 ...
 <%
					...
					dim i,j
					strFileName="splist.asp?splb="&splb&"&spgqlb="&spgqlb
					dim strPurview
					...
					sql="select * from spw where sptop1=false and splb='办公厂房'"
              ...
              <td width="596" valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="5">
                <tr>
                      <td>&nbsp;<a href="index.asp">返回首页</a>&nbsp;&gt;&gt;&gt;&nbsp;商铺展示&nbsp;&gt;&gt;&gt;&nbsp;工业厂房</td>
                </tr>
              </table>
...
%>
                      <TABLE width=100% border=0 align="center" cellPadding=0 cellSpacing=0 style="FONT-SIZE: 12px">
                        <TBODY>
                          ...
                          <tr>
                            <td width="75"><a href="sqdetails.asp?id=<%=rs("id")%>" target="_blank"><img src="<%=rs("spphoto")%>" border="1" class="img-75_85"></a></td>
