...
<tr> 
<th height="23" colspan="3" class="tableHeaderText">论坛帮助管理 | <a href="boardhelp.asp" target=_blank><font color=#FFFFFF>预览帮助</font></a></th>
</tr>
<FORM METHOD=POST ACTION="admin_help.asp?action=search">
<tr>
...
<FORM METHOD=POST ACTION="admin_help.asp?action=save1">
<table width=100% >
...
<tr><td width=40>类型：</td><td width=*><input type=checkbox name="stype" checked value="1">&nbsp;选择此项所添加内容将不显示在帮助文件首页中</td></tr>
<tr><td width=40>内容：</td><td width=*>
<textarea name="content" cols="80" rows="8" ID="TDcontent"></textarea><a href="javascript:admin_Size(-8,'TDcontent')"><img src="images/manage/minus.gif" unselectable="on" border='0'></a> <a href="javascript:admin_Size(8,'TDcontent')"><img src="images/manage/plus.gif" unselectable="on" border='0'></a>
</tr>
<tr><td width=40>&nbsp;</td><td width=*><input type=submit name=submit value="保 存"></td></tr>
</table>
</FORM>
</td>
</tr>
...
<tr> 
<th height="23" class="tableHeaderText" colspan=2>论坛帮助和后台菜单管理列表</th>
</tr>
<%
...
[<a href="admin_help.asp?action=view&id=<%=rs(0)%>">查看内容</a>] [<a href="admin_help.asp?action=edit&id=<%=rs(0)%>">编辑</a>] [<a href="admin_help.asp?action=del&id=<%=rs(0)%>">删除</a>]
</td>
</tr>
...
%>
<tr> 
<td height="23" class="forumrowhighlight" colspan=2>没有找到任何帮助</td>
</tr>
<%
end if
rs.close
...
dim pcount,endpage
	...
	response.write "<table width=""100%""><tr><td valign=middle nowrap class=forumrowhighlight>页次：<b>"&currentpage&"</b>/<b>"&Pcount&"</b>页"
	response.write "&nbsp;每页<b>10</b> 总数<b>"&totalrec&"</b></td>"
	response.write "<td valign=middle nowrap align=right class=forumrowhighlight>分页："
...
<tr> 
<th height="23" class="tableHeaderText">查看论坛帮助</th>
</tr><tr> 
...
if rs.eof and rs.bof then
	...
	Response.Write "<div align=right>[<a href=admin_help.asp?action=edit&id="&rs(0)&">编辑</a>] [<a href=admin_help.asp?action=del&id="&rs(0)&">删除</a>]</div>"
end if
%>
</td>
</tr>
...
<tr> 
<th height="23" class="tableHeaderText">论坛帮助编辑</th>
</tr><tr> 
<td height="23" class="forumrowhighlight">
<%
dim trs
...
%>
<FORM METHOD=POST ACTION="admin_help.asp?action=save3">
...
<tr><td width=40>类型：</td><td width=*><input type=checkbox name="stype" value="1" <%if rs("h_stype")=0 then Response.Write "checked"%>>&nbsp;选择此项所添加内容将不显示在左边菜单中(后台有效)</td></tr>
...
<tr><td width=40>&nbsp;</td><td width=*><input type=submit name=submit value="保存修改"></td></tr>
</table>
</FORM>
<%
end if
