...
<tr> 
<td width="100%" class=ForumrowHighlight colspan=2>
<input type=checkbox name="getskinid" value="1" <%if request("getskinid")="1" or request("boardid")="" then Response.Write "checked"%>><a href="admin_wealth.asp?getskinid=1">论坛默认积分</a><BR> 点击此处返回论坛默认积分设置，默认积分设置包含所有<FONT COLOR="blue">除</FONT>包含具体版面内容（如发贴、回帖、精华等）<FONT COLOR="blue">以外</FONT>的页面。<hr size=1 width="90%" color=blue>
</td>
</tr>
<tr>
