...
function Checkdata()
{
	...
	{
		document.getElementById("constr").innerHTML=" <font color=\"#FF0000\">←请填写贴子内容</font>"
		IframeID.focus();
		ischeck=false
	}
	else if (document.getElementById('Body').value.length>MaxConlength)
	{
		document.getElementById("constr").innerHTML=" <font color=\"#FF0000\">←贴子内容长度不能大于"+MaxConlength+",您已经输入了"+document.getElementById('body').value.length+"个字</font>"
		IframeID.focus();
		ischeck=false
	}
	if (ischeck==false)
