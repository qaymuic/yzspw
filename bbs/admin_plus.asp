...
<tr><th width="100%" class="tableHeaderText" colspan=2>论坛插件菜单管理
</th>
</tr>
<tr>
<td height="23" colspan="2" class=forumrow>注意：这里所添加内容将自动显示于论坛前台的顶部菜单</td>
</tr>

<tr>
<td height="23" colspan="2" class="tableHeaderText">
<a href="admin_plus.asp">菜单管理首页</a>
...
%>
 | 编辑菜单 | <a href="admin_plus.asp?action=AddNew">新建菜单</a></td>
</tr>
...
<tr>
<td height="23" colspan="2" class=forumrow>
是否在导航中显示： 是  <Input type="radio" name="Isuse" value="1"
<%
If trs("Isuse")=1 Then 
%>
 checked
...
<tr><th height="25" colspan="2" >插件常规设置</th></tr>
<tr><td height="23" colspan="2" class=forumrow> 插件ID&nbsp;&nbsp;<input type=text name="plusID" value="<%=Trs("plus_ID")%>" size="20">这是你插件的唯一的标识，注意不能有重复的。
...
%>
<tr><td height="23" colspan="2" class=forumrow>是否定时开放&nbsp;&nbsp; 是  <Input type="radio" name="useTime" value="1"
<%
If PSetting(3)(0)="1" Then Response.Write "checked"
%>
>  否  <input type="radio" name="useTime" value="0" 
<%
If PSetting(3)(0)="0" Then Response.Write "checked"
%>
></td></tr>
<tr><td height="23" colspan="2" class=forumrow>定时开放起止时间&nbsp;&nbsp; <input type=text name="timesetting" value="<%=PSetting(3)(1)%>" size=10></td></tr>
<tr><td height="23" colspan="2" class=forumrow>能使用插件的用户组&nbsp;&nbsp; <input type=text name="Groupsetting" value="<%=PSetting(3)(2)%>" size=30>这里设置可以使用插件的用户组</td></tr>
<tr><td height="23" colspan="2" class=forumrow>管理人员&nbsp;&nbsp; <textarea  name="plusmaster" cols="50" rows="5" ><%=Replace(PSetting(3)(3),"|",vbCrLf)%></textarea><br>这里设置插件的管理员，每个用户名用回车分隔开.系统默认论坛管理员可以管理插件，如果您不需要另外设置管理员，此项可以不填。</td></tr>
<tr><th height="25" colspan="2" >限制项</th></tr>
<tr><td height="23" colspan="2" class=forumrow> 能使用插件的最少文章&nbsp;&nbsp;<input type=text name="Plus_UserPost" value=<%=PSetting(3)(4)%> size=5></td></tr>
<tr><td height="23" colspan="2" class=forumrow> 能使用插件的最低金钱&nbsp;&nbsp;<input type=text name="Plus_userWealth" value=<%=PSetting(3)(5)%> size=5></td></tr>
<tr><td height="23" colspan="2" class=forumrow> 能使用插件的最低经验&nbsp;&nbsp;<input type=text name="Plus_UserEP" value=<%=PSetting(3)(6)%> size=5></td></tr>
<tr><td height="23" colspan="2" class=forumrow> 能使用插件的最低魅力&nbsp;&nbsp;<input type=text name="Plus_UserCP" value=<%=PSetting(3)(7)%> size=5></td></tr>
<tr><td height="23" colspan="2" class=forumrow> 能使用插件的最低威望&nbsp;&nbsp;<input type=text name="Plus_UserPower" value=<%=PSetting(3)(8)%> size=5></td></tr>
<tr><th height="25" colspan="2" >更新项</th></tr>
<tr><td height="23" colspan="2" class=forumrow> 每次使用插件金钱变化&nbsp;&nbsp;<input type=text name="Plus_ADDuserWealth" value=<%=PSetting(3)(9)%> size=5></td></tr>
<tr><td height="23" colspan="2" class=forumrow> 每次使用插件经验变化&nbsp;&nbsp;<input type=text name="Plus_ADDUserEP" value=<%=PSetting(3)(10)%> size=5></td></tr>
<tr><td height="23" colspan="2" class=forumrow> 每次使用插件魅力变化&nbsp;&nbsp;<input type=text name="Plus_ADDUserCP" value=<%=PSetting(3)(11)%> size=5></td></tr>
<tr><td height="23" colspan="2" class=forumrow> 每次使用插件威望变化&nbsp;&nbsp;<input type=text name="Plus_ADDUserPower" value=<%=PSetting(3)(12)%> size=5></td></tr>
<%
Else 
%>
<tr><td height="23" colspan="2" class=forumrow>是否定时开放&nbsp;&nbsp; 是  <Input type="radio" name="useTime" value="1">  否  <input type="radio" name="useTime" value="0" checked></td></tr>
<tr><td height="23" colspan="2" class=forumrow>定时开放起止时间&nbsp;&nbsp; <input type=text name="timesetting" value="0|24" size=10></td></tr>
<tr><td height="23" colspan="2" class=forumrow>能使用插件的用户组&nbsp;&nbsp; <input type=text name="Groupsetting" value="1@2@3@4@5@6@7@8" size=30>这里设置可以使用插件的用户组</td></tr>
<tr><td height="23" colspan="2" class=forumrow>管理人员&nbsp;&nbsp; <textarea  name="plusmaster" cols="50" rows="5" ></textarea><br>这里设置插件的管理员，每个用户名用回车分隔开.系统默认论坛管理员可以管理插件，如果您不需要另外设置管理员，此项可以不填。</td></tr>
<tr><th height="25" colspan="2" >限制项</th></tr>
<tr><td height="23" colspan="2" class=forumrow> 能使用插件的最少文章&nbsp;&nbsp;<input type=text name="Plus_UserPost" value=0 size=5></td></tr>
<tr><td height="23" colspan="2" class=forumrow> 能使用插件的最低金钱&nbsp;&nbsp;<input type=text name="Plus_userWealth" value=0 size=5></td></tr>
<tr><td height="23" colspan="2" class=forumrow> 能使用插件的最低经验&nbsp;&nbsp;<input type=text name="Plus_UserEP" value=0 size=5></td></tr>
<tr><td height="23" colspan="2" class=forumrow> 能使用插件的最低魅力&nbsp;&nbsp;<input type=text name="Plus_UserCP" value=0 size=5></td></tr>
<tr><td height="23" colspan="2" class=forumrow> 能使用插件的最低威望&nbsp;&nbsp;<input type=text name="Plus_UserPower" value=0 size=5></td></tr>
<tr><th height="25" colspan="2" >更新项</th></tr>
<tr><td height="23" colspan="2" class=forumrow> 每次使用插件金钱变化&nbsp;&nbsp;<input type=text name="Plus_ADDuserWealth" value=0 size=5></td></tr>
<tr><td height="23" colspan="2" class=forumrow> 每次使用插件经验变化&nbsp;&nbsp;<input type=text name="Plus_ADDUserEP" value=0 size=5></td></tr>
<tr><td height="23" colspan="2" class=forumrow> 每次使用插件魅力变化&nbsp;&nbsp;<input type=text name="Plus_ADDUserCP" value=0 size=5></td></tr>
<tr><td height="23" colspan="2" class=forumrow> 每次使用插件威望变化&nbsp;&nbsp;<input type=text name="Plus_ADDUserPower" value=0 size=5></td></tr>
<%
End If
%>
<tr><td height="23" colspan="2" class=forumrow>注意，如果用户组中的客人组(ID为7)设置为可进入，那么所有的限制项无效。<Br>更新项中如果是客人可使用，对客人无效</td></tr>
<tr><th height="25" colspan="2" >插件自定权限设置</th></tr>
...
<%else%>
<tr>
<th height="23" colspan="2">添加菜单</th>
</tr>
...
<tr>
<td height="23" colspan="2" class=forumrow>
是否在导航中显示： 是  <Input type="radio" name="Isuse" value="1" checked>  否  <input type="radio" name="Isuse" value="0" >
</td></tr>
<tr>
<td height="23" colspan="2" class=forumrow>
分类：
...
<tr><th height="25" colspan="2" >插件常规设置</th></tr>
<tr><td height="23" colspan="2" class=forumrow> 插件ID&nbsp;&nbsp;<input type=text name="plusID" value="newplus1" size="20">这是你插件的唯一的标识，注意不能有重复的。
<a href="http://bbs.dvbbs.net/Dv_plusInfo.asp" target="_blank" title="到动网官方站查询关于插件的信息" >获得插件ID和信息</a> </td></tr>
<tr><td height="23" colspan="2" class=forumrow>是否定时开放&nbsp;&nbsp; 是  <Input type="radio" name="useTime" value="1">  否  <input type="radio" name="useTime" value="0" checked></td></tr>
<tr><td height="23" colspan="2" class=forumrow>定时开放起止时间&nbsp;&nbsp; <input type=text name="timesetting" value="0|24" size=10></td></tr>
<tr><td height="23" colspan="2" class=forumrow>能使用插件的用户组&nbsp;&nbsp; <input type=text name="Groupsetting" value="1@2@3@4@5@6@7@8" size=30>这里设置可以使用插件的用户组</td></tr>
...
<tr><td height="23" colspan="2" class=forumrow> 每次使用插件威望变化&nbsp;&nbsp;<input type=text name="Plus_ADDUserPower" value=0 size=5></td></tr>
<tr><td height="23" colspan="2" class=forumrow>注意，如果用户组中的客人组(ID为7)设置为可进入，那么所有的限制项无效。<Br>更新项中如果是客人可使用，对客人无效</td></tr>
<tr><th height="25" colspan="2" >插件自定义扩展设置</th></tr>
<tr><td height="23" colspan="2" class=forumrow>
<textarea name="Plus_Setting" cols="80" rows="20">
设置字段1=0
设置字段2=0
...
<table width="95%" border="0" cellspacing="1" cellpadding="3"  align=center class="tableBorder">
<tr><th width="100%" class="tableHeaderText" colspan=5>论坛插件菜单管理
</th>
</tr>
<tr>
<td height="23" colspan="5" class=forumrow>注意：这里所添加内容将自动显示于论坛前台的顶部菜单</td>
</tr>
<tr>
<td height="23" colspan="5" class=forumrow><a href="admin_plus.asp?action=AddNew">新建菜单</a> | <a href="admin_plus.asp?action=posttodb">导出插件模板数据</a> | <a href="admin_plus.asp?action=getfromdb">导入插件模板数据</a></td>
</tr>
<tr>
<th height="23">标题</th>
<th>分类</th>
...
sub savenew()
	...
	If request("title")="" then
		Response.Write "请输入菜单的标题！"
		exit sub
	End If
	If plusID="" Then
		Response.Write "请设定插件ID"
		exit sub
	End If
	SQL="Select count(*) From Dv_plus where plus_ID='"&plusID&"'"
	Set rs=Dvbbs.execute(SQL)
	If Rs(0) >0 Then
		Response.Write "你设置的插件ID已经存在，请另行设置。"
		exit sub
	End If
	Isuse=Request("Isuse")
