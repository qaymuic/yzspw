...
<tr><td height="22"><li>Dv_plus.Mian_settings(6) 能使用插件的最低经验。缺省值为：<%=Dv_plus.Mian_settings(6)%></td></tr>
...
<tr><td height="22"><li>Dv_plus.Mian_settings(10) 每次使用插件经验变化。缺省值为：<%=Dv_plus.Mian_settings(10)%></td></tr>
...
<tr><td height="22"><li>方法Dv_plus.updateuser() 可自动根据设置更新用户的金钱、经验、魅力、威望.插件开发者可根据自己的需要调用。</td></tr>
</table>
<%
Set Dv_plus=Nothing 
Dvbbs.Footer
