...
<div class="yToolbar"> 
  ...
  <div class="TBSep"></div>
  <div class="Btn" TITLE="查看帮助" LANGUAGE="javascript" onclick="help()"> <img class="Ico" src="images\help.gif" WIDTH="16" HEIGHT="16"> 
  </div>
  <div class="TBSep"></div>
...
<div class="yToolbar"> 
  ...
  <div class="TBSep"></div>
  <div class="Btn" TITLE="字体颜色" LANGUAGE="javascript" onclick="foreColor()"> <img class="Ico" src="images\fgcolor.gif" WIDTH="16" HEIGHT="16"> 
  </div>
  <div class="TBSep"></div>
